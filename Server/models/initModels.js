...
import _user_usdt from "./model/user_usdt.js";
import _user_eth_bill from "./model/user_eth_bill.js";
import _user_usdt_bill from "./model/user_usdt_bill.js";
...
import _player_mint_one from "./model/player_mint_one.js";
import _user_withdraw from "./model/user_withdraw.js";
...
function initModels(sequelize) {
  ...
  const userUsdt = _user_usdt(sequelize, DataTypes);
  const userEthBill = _user_eth_bill(sequelize, DataTypes);
  const userUsdtBill = _user_usdt_bill(sequelize, DataTypes);
  ...
  const playerMintOne = _player_mint_one(sequelize, DataTypes);
  const userWithdraw = _user_withdraw(sequelize, DataTypes);
