    ...
    >
      <div class="leftMoboleNavContainer">
        ...
        <div class="item socialLinks">
          <img :src="getImagePath('Telegram.png')"/>
          <img :src="getImagePath('Youtube.png')"/>
          <a href="https://x.com/web3withbinance?s=21">
            <img :src="getImagePath('Twitter.png')"/>
          </a>
        </div>
      </div>
    </el-drawer>
...
import {copyOriginLink, elTip, getImagePath, getSvgPath, handleAddress} from "@/utils/index.js";
